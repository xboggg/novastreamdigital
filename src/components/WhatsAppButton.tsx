...
const WHATSAPP_NUMBER = '4915757178561';
const DEFAULT_MESSAGE = 'Hello! I visited your website and would like to discuss a project.';
          ...
          >
            ...
            <div className="bg-[#25D366] p-4 text-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold">NovaStream Digital</h3>
            ...
            <div className="p-4 bg-background">
              <button
                ...
                className="w-full py-3 px-4 rounded-xl bg-[#25D366] hover:bg-[#128C7E] text-white font-medium transition-colors flex items-center justify-center gap-2"
              >
